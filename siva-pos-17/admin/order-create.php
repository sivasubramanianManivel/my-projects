...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class=" m-2 mb-0">Create Order
            ...
            <form action="orders-code.php" method="POST">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="product_id" class="form_select mySelect2 ">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" value="" id="cphone" class="form-control" >
                            </div>
                            <div class="col-md-4">
                                <br/>
